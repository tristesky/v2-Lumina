...
public class Global
{
    ...
    public const string AppName = "Lumina";
    public const string GithubUrl = "https://github.com";
    public const string GithubApiUrl = "https://api.github.com/repos";
    public const string GeoUrl = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/{0}.dat";
    public const string SingboxRulesetUrl = @"https://raw.githubusercontent.com/2dust/sing-box-rules/rule-set-{0}/{1}.srs";

    public const string PromotionUrl = @"aHR0cHM6Ly9lbi5oaWZ1OC5jb20=";
    ...
    public const string AutoRunName = "LuminaAutoRun";
    ...
    public const string AvaAssets = "avares://Lumina/Assets/";
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.v2rayN, "tristesky/tyleo" },
    };
